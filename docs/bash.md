...
ros2 launch turtlebot4_navigation nav2.launch.py namespace:=/robot3 params_file:=$HOME/rokey_ws/configs/nav2_net.yaml
ros2 launch turtlebot4_navigation nav2.launch.py namespace:=/robot3 params_file:=$HOME/rokey_ws/configs/nav2_net2.yaml
